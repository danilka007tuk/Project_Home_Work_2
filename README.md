...
#  НОВЫЙ ФУНКЦИОНА ПРОЕКТА "МОЙ ВИДЖЕТ"

## Первые этапы разработки:

## Создан модуль search_str_description для реализации двух функций:

### Были созданы две функции filter_transactions и count_transactions_by_category в модуле search_str_description

**Выполнение функции filter_transactions: """Функция принимает список словарей с данными о банковских операциях и строку поиска,
а возвращает список словарей, у которых в описании есть данная строка"""**


**Выполнение функции count_transactions_by_category: """Функция принимает список словарей с данными о банковских операциях и список категорий операций,
а возвращает словарь, в котором ключи — это названия категорий,
а значения — это количество операций в каждой категории."""**

## Новые функции протестированы и тесты добавлены в пакет tests

## Главная разработка заключалась в  новом созданном модуле main_3 который включал в себя функцию main

### Функция майн: """Отвечает за основную логику проекта и связывает функции между собой"""

### Также был создан новый модуль develop_main_3 для реализации функции main 

## В модуле develop_main_3 находятся подобие функций который были созданы ранее и используются для реализации main_3
