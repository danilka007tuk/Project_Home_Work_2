...
from src.decorators import log, predicate_is_filter, predicate_is_sort


@log(predicate_is_filter, "Отсутствует аргумент ввода")
...
@log(predicate_is_sort, "Отсутствует аргумент ввода")
